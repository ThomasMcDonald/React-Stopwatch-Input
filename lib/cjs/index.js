...
function TimeSeriesInput(props) {
    ...
    return (react_1.default.createElement("input", { id: id, className: className, value: value, name: name, placeholder: "mm:ss.ms", required: required, maxLength: 8, onChange: inputChangeEvent }));
}
exports.default = TimeSeriesInput;
